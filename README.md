...
|--------|-------------|------|
| 🏛️ [Heritage Tourism Guide](https://github.com/Keerthanm17/heritage-guide) | CNN-powered, multilingual TTS guide for smart tourism | [Live Demo](https://indiantourister.netlify.app/) |
| 📅 [Attendance Management System](https://github.com/Keerthanm17/attandance_system) | Flask + Firebase-based prototype for tracking attendance with admin approval workflow | [Live Demo](https://attendance-system-mvj.netlify.app/)|
